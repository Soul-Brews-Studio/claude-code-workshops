---
title: Hooks + Skills
description: Advanced Claude Code module - deterministic guardrails + reusable workflows (54 slides)
source: Thor forged from digger cc-workshop-skills handoff + claude-code-guide_TH.pdf + Anthropic docs
---
